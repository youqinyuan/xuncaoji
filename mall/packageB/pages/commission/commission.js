// packageB/pages/commission/commission.js
...
Page({
  ...
  onShareAppMessage: function() {
    return {
      path: "/packageB/pages/commission/commission?inviterCode=" + wx.getStorageSync('inviterCode'),
    }
  },
  //点击复制
  copyText: function(e) {
  ...
  jumpCoomDe: function() {
    wx.navigateTo({
      url: '/packageB/pages/commissionDetail/commissionDetail',
    })
  },
  //提现
  showDetail: function() {
