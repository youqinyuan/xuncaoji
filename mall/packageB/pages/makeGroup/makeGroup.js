// packageB/pages/makeGroup/makeGroup.js
let app = getApp()
Page({
  ...
  screenCondition(e) {
    ...
    if (status == 0) {
      that.data.navData.forEach((v, i) => {
        that.data.navData[1].img = app.Util.getUrlImg().hostUrl + '/add/ic_more.png'
        that.data.navData[2].img = app.Util.getUrlImg().hostUrl + '/add/ic_more.png'
      })
      that.setData({
      ...
      if (that.data.business % 2 !== 0) {
        that.data.navData.forEach((v, i) => {
          that.data.navData[0].img = app.Util.getUrlImg().hostUrl + '/add/ic_more.png'
        })
        that.setData({
          navData: that.data.navData,
          choose: false
        ...
        that.data.navData.forEach((v, i) => {
          that.data.navData[0].img = '/assets/images/temp/takeout_sana.png'
        })
        that.setData({
          navData: that.data.navData,
          choose: true
      ...
      if (that.data.nearby % 2 !== 0) {
        ...
        that.data.navData.forEach((v, i) => {
          that.data.navData[1].img = '/assets/images/temp/takeout_sana.png'
        })
        that.setData({
          navData: that.data.navData,
          choose: true
      ...
      if (that.data.compare % 2 !== 0) {
        ...
        that.data.navData.forEach((v, i) => {
          that.data.navData[2].img = '/assets/images/temp/takeout_sana.png'
        })
        that.setData({
          navData: that.data.navData,
          choose: true
