      ...
      if (ops.target.id === 'btn') {
        ...
        if (that.data.type == 1) {
          ...
          return {
            ...
            path: "/packageA/pages/zeroBuy/zeroBuy?inviterCode=" + wx.getStorageSync('inviterCode') + "&&type=" + 1,
          ...
          return {
            ...
            path: "/packageA/pages/zeroBuy/zeroBuy?inviterCode=" + wx.getStorageSync('inviterCode') + "&&type=" + 2,
            imageUrl: '/packageA/img/xuncaoji_cheats.png',
          }
        } else if (that.data.type == 4) {
          app.Util.ajax('mall/weChat/sharing/onSuccess', {
          ...
          return {
            ...
            path: "/packageA/pages/zeroBuy/zeroBuy?inviterCode=" + wx.getStorageSync('inviterCode') + "&&type=" + 4,
            imageUrl: '/packageA/img/xuncaoji_cheats.png',
          }
        }
