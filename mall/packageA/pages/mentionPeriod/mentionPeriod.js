...
Page({
  ...
  onShow: function() {
    let that = this
    let waitReentry = wx.getStorageSync('waitReentry1') 
    if (waitReentry) {
  ...
  onUnload: function() {
    ...
    wx.removeStorageSync('waitReentry1')
  ...
  chooseReturn: function() {
    wx.navigateTo({
      url: '/packageB/pages/waitReentryDetail/waitReentryDetail?goMentionPeriod=1',
    })
    wx.setStorage({
      key: "goMentionPeriod",
      data: "1"
